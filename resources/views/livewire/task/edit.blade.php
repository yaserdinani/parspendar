        ...
        <form wire:submit.prevent='update'>
            <div class="form-row">
              ...
              <div class="form-group col-md-6 text-right">
                ...
                <input type="text" class="form-control text-right" wire:model.lazy="name" id="name" placeholder="نام" required autocomplete="off">
                @error('name')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6 text-right">
                    @if(auth()->user()->is_admin)
                        ...
                        <select multiple class="form-control" id="users" wire:model="persons">
            ...
            <div class="form-row">
              <div class="form-group col-md-6 text-right">
                ...
                <input type="date" class="form-control text-right" wire:model.lazy="finished_at" id="finished_at"  required autocomplete="off">
                @error('finished_at')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
              <div class="form-group col-md-6 text-right">
                ...
                <input type="date" class="form-control text-right" wire:model.lazy="started_at" id="started_at"  required autocomplete="off">
                @error('started_at')
                  <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
