            ...
            <form action="{{ route('tasks.store') }}" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 text-right">
                        ...
                        <input type="text" class="form-control text-right" name="name" id="name"
                            placeholder="نام" required autocomplete="off" value="{{ old('name') }}">
                        @error('name')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6 text-right">
                        ...
                        <input type="date" class="form-control text-right" name="finished_at" id="finished_at" required
                            autocomplete="off" value="{{ old('finished_at') }}">
                        @error('finished_at')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group col-md-6 text-right">
                        ...
                        <input type="date" class="form-control text-right" name="started_at" id="started_at" required
                            autocomplete="off" value="{{ old('started_at') }}">
                        @error('started_at')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
